...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className="flex flex-col border-r border-gray-700 bg-[#05050591] text-primary-grey-300 min-w-[227px] sticky left-0 h-full max-sm:hidden select-none overflow-y-auto pb-20">
        <h3 className="border-b border-gray-800 px-5 py-4 text-xs uppercase">Layers</h3>
