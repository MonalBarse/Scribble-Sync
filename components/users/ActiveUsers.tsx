...
const ActiveUsers = () => {
  ...
  const others = useOthers(); // useOthers returns the list of other users in the room.
  const currentUser = useSelf(); //useSelf returns the current user details in the room
